          ...
          <el-table :data="modelList" size="small">
            ...
            <el-table-column prop="type" label="类型" width="100">
              <template #default="{ row }">
                <el-tag :type="row.type === 'detection' ? 'primary' : 'success'" size="small">
            ...
            <el-table-column prop="status" label="状态" width="80">
              <template #default="{ row }">
                <el-tag :type="row.status === 'loaded' ? 'success' : 'info'" size="small">
        ...
        <el-card shadow="hover" style="margin-top: 20px">
          ...
          <el-descriptions :column="1" border>
            ...
            <el-descriptions-item label="CPU使用率">
              <el-progress :percentage="systemStats.cpuUsage" :stroke-width="8" />
            </el-descriptions-item>
            <el-descriptions-item label="内存使用率">
              <el-progress :percentage="systemStats.memoryUsage" :stroke-width="8" />
            </el-descriptions-item>
...
const beforeModelUpload = (file: File) => {
  const isValidFormat = file.name.endsWith('.onnx') ||
